...
const reducer = produce((draft, { colourPalette, theme, marksPlacement, autofill,
    selectionColour, customColours, zoom, fontSizeFactorDigits, fontSizeFactorCornerMarks,
